...
enum Endpoints: String {
    case recipes = "https://themealdb.com/api/json/v1/1/filter.php?c=Dessert"
...
struct URLService {
    ...
    static func getData<T>(from endpoint: Endpoints, with id: String? = nil) async throws -> T where T: Decodable {
        do {
